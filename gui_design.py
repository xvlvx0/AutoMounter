...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget = QtWidgets.QWidget(
            self.frame_box_mountpoints)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 30, 281, 391))
        self.verticalLayoutWidget.setObjectName('verticalLayoutWidget')
        self.verticalLayout_mountpoints = QtWidgets.QVBoxLayout(
            self.verticalLayoutWidget)
        self.verticalLayout_mountpoints.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_mountpoints.setObjectName(
            'verticalLayout_mountpoints')
        ...
        self.pushButton_cleartext = QtWidgets.QPushButton(
            self.frame_box_textwindow)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(
            ...
            _translate('MainWindow', 'Mounts'))
        self.pushButton_save.setText(_translate('MainWindow', 'Save'))
        self.pushButton_cancel.setText(_translate('MainWindow', 'Cancel'))
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tab_2),
            _translate('MainWindow', 'Config'))
    ...
    def makeMountItem(self, n):
        ...
        self.pushButton_1.clicked.connect(lambda: self.bt_clk())
